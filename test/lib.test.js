...
describe('lib', () => {
    ...
    test('generatePriceString', () => {
        ...
        expect(generatePriceString({ priceRange: { minimum: { regular: value100, final: value80 }, maximum: { regular: value100, final: value100 }}})).toBe('<s>EUR 100.00</s> EUR 80.00-EUR 100.00');

        // Minimum normal, maximum discounted
        expect(generatePriceString({ priceRange: { minimum: { regular: value100, final: value100 }, maximum: { regular: value100, final: value80 }}})).toBe('EUR 100.00-<s>EUR 100.00</s> EUR 80.00');

        // Both discounted
        expect(generatePriceString({ priceRange: { minimum: { regular: value80, final: value60 }, maximum: { regular: value100, final: value80 }}})).toBe('<s>EUR 80.00</s> EUR 60.00-<s>EUR 100.00</s> EUR 80.00');

        // Equal range
        // With discount
        expect(generatePriceString({ priceRange: { minimum: { regular: value80, final: value60 }, maximum: { regular: value100, final: value60 }}})).toBe('<s>EUR 80.00</s> EUR 60.00');

        // Without discount
        expect(generatePriceString({ priceRange: { minimum: { regular: value80, final: value80 }, maximum: { regular: value80, final: value80 }}})).toBe('EUR 80.00');

        // No range
        // With discount
        expect(generatePriceString({ price: { regular: value100, final: value80 }})).toBe('<s>EUR 100.00</s> EUR 80.00');

        // No discount
        expect(generatePriceString({ price: { regular: value100, final: value100 }})).toBe('EUR 100.00');
    });
});